...
public class A5_ConsultantEducationEnglishTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(A5_ConsultantEducationEnglishTest.class);
	...
	public void test_005_2() throws InterruptedException {
		...
		// Wait until "Education" link is active
		wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Education")));
		
		// Go to Education
		Functions.driver.findElement(By.linkText("Education")).click();
